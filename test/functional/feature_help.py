...
"""Verify that starting gothcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gothcoin with -h for help text")
        ...
        self.log.info("Start gothcoin with -version for version information")
        ...
        self.log.info("Start gothcoind with -fakearg to make sure it does not start")
