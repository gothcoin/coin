...
#
# Test new Gothcoin multisig prefix functionality.
#
...
class ScriptAddress2Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(multisig_addr[0], 'X')
        ...
        priv_keys = ["cU7eeLPKzXeKMeZvnEJhvZZ3tLqVF3XGeo1BbM8dnbmV7pP3Xg89",
        ...
        assert_equal(multisig_addr_new, 'XZ974ZrPrmqMmm1PSVp4m8YEgo3bCXZBbe')
        multisig_addr_old = "2N5nLwYz9qfnGdaFLpPn3gS6oYXbmLTWPjq"
