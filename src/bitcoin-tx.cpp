...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gothcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gothcoin-tx [options] <hex-tx> [commands]  Update hex-encoded gothcoin transaction\n" +
            "or:     gothcoin-tx [options] -create [commands]   Create hex-encoded gothcoin transaction\n" +
            "\n";
