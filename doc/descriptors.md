# Support for Output Descriptors in Gothcoin Core

Since Gothcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `goth1...` for mainnet or `tgoth1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Gothcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Gothcoin Core wallets, a convenience function `combo` is
