...
bech32_templates = [
  ...
  ('goth',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('goth',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('goth',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tgoth',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tgoth',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tgoth',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rgoth',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rgoth',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rgoth', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tgoth',  17, 32, False, False, False),
  ('rgoth',  3,  1, False, False, False),
  ('goth',   15, 41, False, False, False),
  ('tgoth',  0, 16, False, False, False),
  ('rgoth',  0, 32, True,  False, False),
  ('goth',   0, 16, True,  False, False),
  ('tgoth',  0, 32, False, True,  False),
  ('rgoth',  0, 20, False, False, True)
]
